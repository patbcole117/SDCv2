...
{"db_drop": false, "l_addr": "0.0.0.0", "l_port": "50200", "sql_addr": "SQL_ADDR", "sql_port": "SQL_PORT", "sql_user": "SQL_USER", "sql_secret": "SQL_SECRET, "sql_db": "SQL_DB", "sql_default_db": "SQL_DEFAULT_DB"}

 # Docker commands:
 sudo docker build -t sdc:latest .
 sudo docker run --name sdc -p 50200:50200 --mount source=sdc_data,target=/SDC/app/mnt sdc
